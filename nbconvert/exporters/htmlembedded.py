...
class HTMLEmbeddedExporter(HTMLExporter):
    """
    ...
    def from_notebook_node(self, nb, resources=None, **kw):
        output, resources = super(
            HTMLEmbeddedExporter, self).from_notebook_node(nb, resources)

        # We should never regex an XML, how
        # ever this is quick and dirty and works
